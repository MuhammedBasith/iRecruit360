          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <Card className="w-full max-w-md p-6 shadow-md" style={{ backgroundColor: 'white', borderColor: '#E5E7EB' }}> {/* Add borderColor to style prop */}
              <div className="flex gap-4"> {/* Wrap the buttons in a flex container */}
                ...
                <Button size="lg" className="bg-gray-800 text-white hover:bg-gray-700 transition duration-300 ease-in-out" variant="outline" onClick={() => {router.push('/admin/show-interviews')}}>
                  Show interviews
                </Button>
              </div>
            </Card>
