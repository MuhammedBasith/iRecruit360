          ...
          <Hero
            ...
            description={
              <FallInPlace delay={0.4} fontWeight="medium">
                Streamline your hiring with us.<Br /> Effortlessly find and onboard top talent,<Br /> no matter the size of your organization.
              </FallInPlace>
            }
          >
