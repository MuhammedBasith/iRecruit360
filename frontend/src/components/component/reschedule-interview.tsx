...
export default function ScheduleInterview() {
  ...
  const checkButtonState = (selectedDate: any, selectedTime: any) => {
  ...
  const handleSendEmail = () => {
    ...
    router.push('/admin/reschedule-progress')
      ...
      <div className="flex justify-center items-center flex-grow" style={{ marginTop: "-5rem" }}>
        <div className="mx-auto max-w-5xl px-4 space-y-6">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-center">Reschedule Interview</h1>
            <p className="text-gray-500 dark:text-gray-400 text-center">
              Enter the date and time you'd like to reschedule your interview to and click the "Send Email" button to confirm.
            </p>
          </div>
