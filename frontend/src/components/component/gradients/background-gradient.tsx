...
export const BackgroundGradient = ({ theme, hideOverlay, ...props }: any) => {
  // const theme = useTheme()
  const colors = [
    '#123456',    // Example primary color
    '#abcdef',    // Example secondary color
    '#00ffff',    // Example cyan color
    '#008080',    // Example teal color
  ];
